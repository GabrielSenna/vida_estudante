<div class="row side-bar-content">
    <div class="side-bar col l2 hide-on-med-and-down">
        ...
        <ul class="collection">
            ...
            <li class=""><a href="#" class="collection-item grey-text">Editar perfil<i class="material-icons right grey-text">person</i></a></li>
            <li class=""><a href="#" class="collection-item grey-text">Amigos<i class="material-icons right grey-text">group</i></a></li>
